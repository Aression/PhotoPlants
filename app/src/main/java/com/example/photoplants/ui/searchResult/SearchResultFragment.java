package com.example.photoplants.ui.searchResult;
...
import com.example.photoplants.databinding.SearchResultFragmentBinding;
...
public class SearchResultFragment extends Fragment {
    ...
    private SearchResultAdapter adapter = new SearchResultAdapter(
            new SearchResultAdapter.StringDiff(),listener
    );
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        backToMain = binding.backToMain1;
        ...
        recyclerView = binding.searchResultRecv;
        recyclerView.setAdapter(adapter);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));

        mViewModel.toBeShownInSearchResults.observe(requireActivity()
